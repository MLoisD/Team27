...
export const FICTION = [
    ...
    {
        BookID: 2,
        BName: "The Last Tale of the flower bride",
    ...
    {
        BookID: 8,
        BName: "Librarian of Burned Books",
