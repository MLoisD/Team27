...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                //.requestMatchers("/book/**").permitAll()
                //.requestMatchers("/book/addBook").permitAll()//.hasRole("ADMIN")
                //.requestMatchers("/book/updateBookStock/{bookID}").permitAll()//.hasRole("ADMIN")
                //.requestMatchers("/book/deleteBook/{bookID}").permitAll()//.hasRole("ADMIN")
                //.requestMatchers("/book/updateBook/{bookID}").permitAll()//.hasRole("ADMIN")
                .and()
                .exceptionHandling()
