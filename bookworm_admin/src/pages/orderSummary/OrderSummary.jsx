...
import {getAllInvoiceDetailSelector, getCurrentBGImage, getCurrentColor, getInvoiceNewForm,getIsConfirm,  setConfirmModalOpen, setDefaultBackground,  setDefaultColor,  setIsConfirm,  setNewInvoices,  setSettingModalOpen,  updateExisitingInvoiceForm,  updateNewInvoiceForm,
} from "../../components/store/invoiceSlice";
import {getSelectedClient,setOpenClientSelector,} from "../../components/store/clientSlice";
import { getCompanyData } from "../../components/store/companySlice";
import { defaultInputSmStyle, IconStyle } from "../../utils/invoiceTableStyles";
...
import { getSelectedProduct,setOpenProductSelector,} from "../../components/store/productSlice";
                            ...
                            {invoiceForm?.statusIndex !== "2" && (
                                <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                                    ...
                                    >
                                        ...
                                        {params.orderSummary === "orderSummary" ? "Save" : "Update"} As Unpaid
                                    </Button>
                                </div>
                            )}
                            <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                                ...
                                >
                                    ...
                                    {params.orderSummary === "orderSummary" ? "Save" : "Update"} As Paid
                                </Button>
                            </div>
                        </div>
                    </div>
