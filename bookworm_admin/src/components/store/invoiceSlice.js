...
import imageData from "../../utils/dummyData/imageData.json";
import colorData from "../../utils/dummyData/colorData.json";
import {
  INVOICES_KEY,
...
export const invoiceSlice = createSlice({
  ...
  reducers: {
    ...
    onConfirmDeletedInvoice: (state, action) => {
      ...
      localStorage.setItem(INVOICES_KEY, newDatas);
      localStorage.setItem(INVOICE_DETAILS, newDetails);
    },
    ...
    onConfirmEditInvoice: (state, action) => {
      ...
      localStorage.setItem(INVOICES_KEY, [...state.data]);
    },
    ...
    updateNewInvoiceForm: (state, action) => {
      ...
      localStorage.setItem(INVOICE_FORM_KEY, { ...state.newForm });
    },
    ...
    updateExisitingInvoiceForm: (state, action) => {
      ...
      localStorage.setItem(INVOICES_KEY, [...state.data]);
      localStorage.setItem(INVOICE_DETAILS, [...state.detailList]);
    },
